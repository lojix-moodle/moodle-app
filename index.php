...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        generateBtn.addEventListener('click', function() {
            ...
            if (code) {
                try {
                    ...
                    barcodeSvg.insertAdjacentHTML('afterend',
                        `<div class="alert alert-danger mt-2">
                    Barkod oluşturulamadı: ${error.message}
                </div>`);
                }
            } else {
        ...
        const stockChart = new Chart(stockChartCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [120, 150, 130, 170, 160, 180, 200, 220, 210, 230, 240, 250, 260, 280, 300, 320, 340, 360, 380, 400],
                    borderColor: '#3498db',
        ...
        const categoryChart = new Chart(categoryChartCtx, {
            type: 'pie',
            data: {
                labels: ['Tekstil', 'Elektronik', 'Gıda', 'Mobilya'],
                datasets: [{
                    data: [300, 150, 100, 50],
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(tooltipItem) {
                                return tooltipItem.label + ': ' + tooltipItem.raw + ' ürün';
                            }
                        }
                    }
                }
