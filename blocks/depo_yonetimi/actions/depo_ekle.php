...
if (isset($_POST['submit']) || (isset($_POST['name']) && isset($_POST['sorumluid']))) {
    ...
    // Hata yoksa kaydet
    if (empty($errors)) {
        $transaction = $DB->start_delegated_transaction(); // Başlatılan transaction'ı bir değişkene atayın
        try {
